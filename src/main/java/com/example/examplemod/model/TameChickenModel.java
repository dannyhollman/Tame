...
/*
@OnlyIn(Dist.CLIENT)
public class TameChickenModel extends ChickenModel<TameChickenEntity>
{
...
@OnlyIn(Dist.CLIENT)
public class TameChickenModel<T extends TameChickenEntity> extends AgeableModel<T> {
