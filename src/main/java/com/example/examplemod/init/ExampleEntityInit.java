...
public class ExampleEntityInit {
	...
	public static final String TAME_CHICKEN_NAME = "tame_chicken_entity";
	...
	public static final String TAME_PANDA_NAME = "tame_panda_entity";
	...
	public static final String TAME_BEE_NAME = "tame_bee_entity";
