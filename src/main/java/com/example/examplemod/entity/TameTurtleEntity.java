...
import com.example.examplemod.goal.NewFollowOwnerGoal;
...
public class TameTurtleEntity extends TameableEntity {
	private static final DataParameter<BlockPos> HOME_POS = EntityDataManager.createKey(TameTurtleEntity.class, DataSerializers.BLOCK_POS);
	private static final DataParameter<Boolean> HAS_EGG = EntityDataManager.createKey(TameTurtleEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> IS_DIGGING = EntityDataManager.createKey(TameTurtleEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<BlockPos> TRAVEL_POS = EntityDataManager.createKey(TameTurtleEntity.class, DataSerializers.BLOCK_POS);
	private static final DataParameter<Boolean> GOING_HOME = EntityDataManager.createKey(TameTurtleEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> TRAVELLING = EntityDataManager.createKey(TameTurtleEntity.class, DataSerializers.BOOLEAN);
	...
	public TameTurtleEntity(EntityType<? extends TameTurtleEntity> type, World worldIn) {
		super(type, worldIn);
		this.setTamed(false);
		this.setPathPriority(PathNodeType.WATER, 0.0F);
		this.moveController = new TameTurtleEntity.MoveHelperController(this);
	...
	public static boolean func_223322_c(EntityType<TameTurtleEntity> p_223322_0_, IWorld p_223322_1_, SpawnReason reason, BlockPos p_223322_3_, Random p_223322_4_) {
	...
	protected void registerGoals() {
		this.goalSelector.addGoal(0, new TameTurtleEntity.PanicGoal(this, 1.2D));
		this.goalSelector.addGoal(1, new TameTurtleEntity.MateGoal(this, 1.0D));
		this.goalSelector.addGoal(1, new TameTurtleEntity.LayEggGoal(this, 1.0D));
		this.goalSelector.addGoal(2, new TameTurtleEntity.PlayerTemptGoal(this, 1.1D, Blocks.SEAGRASS.asItem()));
		this.goalSelector.addGoal(3, new NewFollowOwnerGoal(this, 1.0D, 10.0F, 2.0F, false));
		this.goalSelector.addGoal(3, new TameTurtleEntity.GoToWaterGoal(this, 1.0D));
		this.goalSelector.addGoal(4, new TameTurtleEntity.GoHomeGoal(this, 1.0D));
		this.goalSelector.addGoal(7, new TameTurtleEntity.TravelGoal(this, 1.0D));
		this.goalSelector.addGoal(8, new LookAtGoal(this, PlayerEntity.class, 8.0F));
		this.goalSelector.addGoal(9, new TameTurtleEntity.WanderGoal(this, 1.0D, 100));
	}
	...
	protected PathNavigator createNavigator(World worldIn) {
		return new TameTurtleEntity.Navigator(this, worldIn);
	}
	...
	static class GoHomeGoal extends Goal {
		private final TameTurtleEntity turtle;
		private final double speed;
		private boolean field_203129_c;
		private int field_203130_d;

		GoHomeGoal(TameTurtleEntity turtle, double speedIn) {
			this.turtle = turtle;
			this.speed = speedIn;
		}
	...
	static class GoToWaterGoal extends MoveToBlockGoal {
		...
		private GoToWaterGoal(TameTurtleEntity turtle, double speedIn) {
	...
	static class LayEggGoal extends MoveToBlockGoal {
		...
		LayEggGoal(TameTurtleEntity turtle, double speedIn) {
	...
	static class MateGoal extends BreedGoal {
		...
		MateGoal(TameTurtleEntity turtle, double speedIn) {
	...
	static class MoveHelperController extends MovementController {
		...
		MoveHelperController(TameTurtleEntity turtleIn) {
			super(turtleIn);
	...
	static class Navigator extends SwimmerPathNavigator {
		Navigator(TameTurtleEntity turtle, World worldIn) {
		...
		public boolean canEntityStandOnPos(BlockPos pos) {
			if (this.entity instanceof TameTurtleEntity) {
				TameTurtleEntity TameTurtleEntity = (TameTurtleEntity)this.entity;
				if (TameTurtleEntity.isTravelling()) {
	...
	static class PanicGoal extends net.minecraft.entity.ai.goal.PanicGoal {
		PanicGoal(TameTurtleEntity turtle, double speedIn) {
			super(turtle, speedIn);
		}
	...
	static class PlayerTemptGoal extends Goal {
		...
		PlayerTemptGoal(TameTurtleEntity turtle, double speedIn, Item temptItem) {
			this.turtle = turtle;
			this.speed = speedIn;
	...
	static class TravelGoal extends Goal {
		...
		TravelGoal(TameTurtleEntity turtle, double speedIn) {
			this.turtle = turtle;
			this.speed = speedIn;
		}
	...
	static class WanderGoal extends RandomWalkingGoal {
		...
		private WanderGoal(TameTurtleEntity turtle, double speedIn, int chance) {
