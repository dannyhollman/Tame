...
public class TameRabbitEntity extends TameableEntity {
	   private static final DataParameter<Integer> RABBIT_TYPE = EntityDataManager.createKey(TameRabbitEntity.class, DataSerializers.VARINT);
	   ...
	   public TameRabbitEntity(EntityType<? extends TameRabbitEntity> p_i50247_1_, World p_i50247_2_) {
	      super(p_i50247_1_, p_i50247_2_);
	      this.jumpController = new TameRabbitEntity.JumpHelperController(this);
	      this.moveController = new TameRabbitEntity.MoveHelperController(this);
	   ...
	   protected void registerGoals() {
	      ...
	      this.goalSelector.addGoal(1, new TameRabbitEntity.PanicGoal(this, 2.2D));
	      ...
	      //this.goalSelector.addGoal(5, new TameRabbitEntity.AvoidEntityGoal<>(this, PlayerEntity.class, 8.0F, 2.2D, 2.2D));
	      this.goalSelector.addGoal(5, new TameRabbitEntity.AvoidEntityGoal<>(this, WolfEntity.class, 10.0F, 2.2D, 2.2D));
	      this.goalSelector.addGoal(5, new TameRabbitEntity.AvoidEntityGoal<>(this, MonsterEntity.class, 4.0F, 2.2D, 2.2D));
	      this.goalSelector.addGoal(6, new TameRabbitEntity.RaidFarmGoal(this));
	   ...
	   public void updateAITasks() {
	      ...
	      if (this.onGround) {
	         ...
	         TameRabbitEntity.JumpHelperController TameRabbitEntity$jumphelpercontroller = (TameRabbitEntity.JumpHelperController)this.jumpController;
	         if (!TameRabbitEntity$jumphelpercontroller.getIsJumping()) {
	         ...
	         } else if (!TameRabbitEntity$jumphelpercontroller.canJump()) {
	   ...
	   private void enableJumpControl() {
	      ((TameRabbitEntity.JumpHelperController)this.jumpController).setCanJump(true);
	   }

	   private void disableJumpControl() {
	      ((TameRabbitEntity.JumpHelperController)this.jumpController).setCanJump(false);
	   }
	   ...
	   public TameRabbitEntity createChild(AgeableEntity ageable) {
	      return null;
	   }
	   ...
	   public void setRabbitType(int rabbitTypeId) {
	      if (rabbitTypeId == 99) {
	         ...
	         this.goalSelector.addGoal(4, new TameRabbitEntity.EvilAttackGoal(this));
	   ...
	   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
	      ...
	      if (spawnDataIn instanceof TameRabbitEntity.RabbitData) {
	         i = ((TameRabbitEntity.RabbitData)spawnDataIn).typeData;
	      } else {
	         spawnDataIn = new TameRabbitEntity.RabbitData(i);
	      }
	   ...
	   public static boolean func_223321_c(EntityType<TameRabbitEntity> p_223321_0_, IWorld p_223321_1_, SpawnReason reason, BlockPos p_223321_3_, Random p_223321_4_) {
	   ...
	   static class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T> {
	      private final TameRabbitEntity rabbit;

	      public AvoidEntityGoal(TameRabbitEntity rabbit, Class<T> p_i46403_2_, float p_i46403_3_, double p_i46403_4_, double p_i46403_6_) {
	   ...
	   static class EvilAttackGoal extends MeleeAttackGoal {
	      public EvilAttackGoal(TameRabbitEntity rabbit) {
	   ...
	   public class JumpHelperController extends JumpController {
	      ...
	      public JumpHelperController(TameRabbitEntity rabbit) {
	         super(rabbit);
	         this.rabbit = rabbit;
	      }
	   ...
	   static class MoveHelperController extends MovementController {
	      ...
	      public MoveHelperController(TameRabbitEntity rabbit) {
	         super(rabbit);
	         this.rabbit = rabbit;
	      }

	      public void tick() {
	         if (this.rabbit.onGround && !this.rabbit.isJumping && !((TameRabbitEntity.JumpHelperController)this.rabbit.jumpController).getIsJumping()) {
	   ...
	   static class PanicGoal extends net.minecraft.entity.ai.goal.PanicGoal {
	      ...
	      public PanicGoal(TameRabbitEntity rabbit, double speedIn) {
	   ...
	   static class RaidFarmGoal extends MoveToBlockGoal {
	      ...
	      public RaidFarmGoal(TameRabbitEntity rabbitIn) {
