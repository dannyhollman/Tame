...
public class TamePigEntity extends TameableEntity {
	private static final DataParameter<Boolean> SADDLED = EntityDataManager.createKey(TamePigEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Integer> BOOST_TIME = EntityDataManager.createKey(TamePigEntity.class, DataSerializers.VARINT);
	...
	public TamePigEntity(EntityType<? extends TamePigEntity> p_i50250_1_, World p_i50250_2_) {
	...
	public TamePigEntity createChild(AgeableEntity ageable) {
		return null;
	}
