...
//@OnlyIn(Dist.CLIENT)
public class TamePandaModel<T extends TamePandaEntity> extends QuadrupedModel<T> {
   private float field_217164_l;
   private float field_217165_m;
   private float field_217166_n;

   public TamePandaModel(int p_i51063_1_, float p_i51063_2_) {
