...
public class ExampleEntityInit {
	...
	public static final RegistryObject<EntityType<TamePigEntity>> TAME_PIG_ENTITY = ENTITY_TYPES.register(TAME_PIG_NAME, () ->
			EntityType.Builder.<TamePigEntity>create(TamePigEntity::new, EntityClassification.CREATURE)
					...
					.build(new ResourceLocation(TameMod.MODID, TAME_PIG_NAME).toString())
	);
	

	public static final String TAME_RABBIT_NAME = "tame_rabbit";
	public static final RegistryObject<EntityType<TameRabbitEntity>> TAME_RABBIT_ENTITY = ENTITY_TYPES.register(TAME_RABBIT_NAME, () ->
			EntityType.Builder.<TameRabbitEntity>create(TameRabbitEntity::new, EntityClassification.CREATURE)
					.size(EntityType.RABBIT.getWidth(), EntityType.RABBIT.getHeight())
					.build(new ResourceLocation(TameMod.MODID, TAME_RABBIT_NAME).toString())
	);
