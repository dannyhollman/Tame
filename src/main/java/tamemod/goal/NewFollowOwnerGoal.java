...
public class NewFollowOwnerGoal extends Goal {
	   ...
	   public NewFollowOwnerGoal(TameableEntity p_i225711_1_, double p_i225711_2_, float p_i225711_4_, float p_i225711_5_, boolean p_i225711_6_) {
	      ...
	      if (!(p_i225711_1_.getNavigator() instanceof GroundPathNavigator) && !(p_i225711_1_.getNavigator() instanceof FlyingPathNavigator) && !(p_i225711_1_.getNavigator() instanceof SwimmerPathNavigator)) {
