...
import tamemod.model.TamePandaModel;

//@OnlyIn(Dist.CLIENT)
public class TamePandaRenderer extends MobRenderer<TamePandaEntity, TamePandaModel<TamePandaEntity>> {
   ...
   public TamePandaRenderer(EntityRendererManager renderManagerIn) {
      super(renderManagerIn, new TamePandaModel<>(9, 0.0F), 0.9F);
   }

   /**
    * Returns the location of an entity's texture.
    */
   public ResourceLocation getEntityTexture(TamePandaEntity entity) {
      return field_217777_a.getOrDefault(entity.func_213590_ei(), field_217777_a.get(PandaEntity.Type.NORMAL));
   }

   protected void applyRotations(TamePandaEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
